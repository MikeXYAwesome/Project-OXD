    ...
    <>
      <div className="ComPageWarp">
        ...
        <div className="variantsWarp">
          ...
          <div className="VBox">
            <p className="Vtitle">When Downloading</p>
            <img src="/img/comsvg/ub06.svg" className="Vimg" />
            <button className="codebt">
              <img src={SvgCodeIcon} />
            </button>
            <div className="StyleSnipit">Code</div>
          ...
          <div className="VBox">
            <p className="Vtitle">When Multiple files</p>
            <img src="/img/comsvg/ub07.svg" className="Vimg" />
            <button className="codebt">
              <img src={SvgCodeIcon} />
            </button>
            <div className="StyleSnipit">Code</div>
          ...
          <div className="VBox">
            <p className="Vtitle"> Multiple files with Icons</p>
            <img src="/img/comsvg/ub08.svg" className="Vimg" />
            <button className="codebt">
              <img src={SvgCodeIcon} />
            </button>
            <div className="StyleSnipit">Code</div>
          ...
          <div className="VBox">
            <p className="Vtitle">Drag and Drop</p>
            <img src="/img/comsvg/ub09.svg" className="Vimg" />
            <button className="codebt">
              <img src={SvgCodeIcon} />
            </button>
            <div className="StyleSnipit">Code</div>
          ...
          <div className="VBox">
            <p className="Vtitle">Complete</p>
            <img src="/img/comsvg/ub10.svg" className="Vimg" />
            <button className="codebt">
              <img src={SvgCodeIcon} />
            </button>
            <div className="StyleSnipit">Code</div>
          ...
          <div className="VBox">
            ...
            <img src="/img/comsvg/ub11.svg" className="Vimg" />
            <button className="codebt">
              <img src={SvgCodeIcon} />
            </button>
            <div className="StyleSnipit">Code</div>
          ...
          <div className="VBox">
            <p className="Vtitle">Drag and Drop</p>
            <img src="/img/comsvg/ub12.svg" className="Vimg" />
            <button className="codebt">
              <img src={SvgCodeIcon} />
            </button>
            <div className="StyleSnipit">Code</div>
