        ...
        e2.exports = function(e3, t3, r3) {
          ...
          function P() {
            ...
            if (o3 = arguments, n2 = this, s2 = e4, r4) {
              ...
              if (f2)
                return c2 = setTimeout(w, t3), m(s2);
            }
      ...
      (() => {
        ...
        function L() {
          return L = Object.assign ? Object.assign.bind() : function(e3) {
            for (var t3 = 1; t3 < arguments.length; t3++) {
              var r2 = arguments[t3];
              for (var o2 in r2)
                ({}).hasOwnProperty.call(r2, o2) && (e3[o2] = r2[o2]);
            }
            return e3;
          ...
          var r2 = function(r3) {
            function o2(e4) {
              ...
              if (function(e5, t3) {
                if (!(e5 instanceof t3))
                  throw new TypeError("Cannot call a class as a function");
              }(this, o2), (r4 = x(this, o2, [e4])).useIntersectionObserver = e4.useIntersectionObserver && i(), r4.useIntersectionObserver)
                return k(r4);
              ...
              var r4 = this.props, o3 = (r4.delayMethod, r4.delayTime, function(e4, t3) {
                ...
                if (Object.getOwnPropertySymbols) {
                  ...
                  for (o4 = 0; o4 < i2.length; o4++)
                    r5 = i2[o4], t3.indexOf(r5) >= 0 || {}.propertyIsEnumerable.call(e4, r5) && (n4[r5] = e4[r5]);
                }
                return n4;
        ...
        function $(e3, t3, r2) {
          return t3 = F(t3), function(e4, t4) {
            if (t4 && ("object" == V(t4) || "function" == typeof t4))
              return t4;
            if (void 0 !== t4)
              throw new TypeError("Derived constructors may only return object or undefined");
            return function(e5) {
        ...
        function ae(e3, t3, r2) {
          return t3 = pe(t3), function(e4, t4) {
            if (t4 && ("object" == re(t4) || "function" == typeof t4))
              return t4;
            if (void 0 !== t4)
              throw new TypeError("Derived constructors may only return object or undefined");
            return function(e5) {
            ...
            var e4 = this.props, r3 = (e4.afterLoad, e4.beforeLoad, e4.delayMethod, e4.delayTime, e4.effect, e4.placeholder, e4.placeholderSrc, e4.scrollPosition, e4.threshold, e4.useIntersectionObserver, e4.visibleByDefault, e4.wrapperClassName, e4.wrapperProps, function(e5, t3) {
              ...
              if (Object.getOwnPropertySymbols) {
                ...
                for (o3 = 0; o3 < i2.length; o3++)
                  r4 = i2[o3], t3.indexOf(r4) >= 0 || {}.propertyIsEnumerable.call(e5, r4) && (n3[r4] = e5[r4]);
              }
              return n3;
            }(e4, oe));
